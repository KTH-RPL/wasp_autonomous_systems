...
int main(int argc, char **argv) {
  ...
  // EXPERIMENTAL macOS fix: /proc doesn't exist on macOS, so this check
  // (which only exists to print an optional deprecation warning) is
  // unconditionally skipped there instead of being treated as fatal.
#ifdef __linux__
